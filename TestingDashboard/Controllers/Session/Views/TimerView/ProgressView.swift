...
extension TimerView {
    final class ProgressView: UIView {
        func drawProgress(with percent: CGFloat) {
            ...
            defaultCircleLayer.strokeColor = UIColor.systemYellow.cgColor
...
//                    ? OverallController.Colors.active.cgColor : OverallController.Colors.separator.cgColor
