        ...
        APICaller.shared.loadProgress { results in
            DispatchQueue.main.async {
                if results.count > 0 {
                    ...
                    print("No results found")
                    // Show an alert to the user indicating no results were found
                    let alert = UIAlertController(title: "No Results Found", message: "No progress results were found.", preferredStyle: .alert)
